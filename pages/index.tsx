...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    const handleParallaxScroll = () => {
      ...
      // Hero parallax effect - just fade, no scale
      if (heroRef.current) {
      ...
      // Section entrance animations with smooth fade
      [aboutRef, projectsRef, contactRef].forEach((ref) => {
        if (ref.current) {
          ...
          const visibleAmount = Math.max(0, Math.min(1, (clientHeight - sectionTop) / (sectionHeight * 0.5)));
          
          // Apply smooth transform
          if (sectionTop < clientHeight && sectionTop > -sectionHeight) {
            const translateY = Math.max(0, (1 - visibleAmount) * 20);
            const opacity = Math.max(0.5, visibleAmount);
  ...
  useEffect(() => {
    ...
    const heroTimeline: any = gsap.timeline({ delay: 0.2 });
    ...
    if (circle && title && subtitle) {
      heroTimeline
        .fromTo(circle, 0.5, { y: "50", opacity: 0 }, { y: 0, opacity: 1 })
        .fromTo(title, 0.5, { y: "50", opacity: 0 }, { y: 0, opacity: 1 })
        .fromTo(subtitle, 0.6, { y: "50", opacity: 0 }, { y: 0, opacity: 1 });
    ...
    const handleScroll = () => {
      ...
      if (aboutRef.current && !hasAnimated.about) {
        ...
        if (rect.top < viewportHeight * 0.7) {
          const tl: any = gsap.timeline({ delay: 0.2 });
      ...
      if (contactRef.current && !hasAnimated.contact) {
        ...
        if (rect.top < viewportHeight * 0.7) {
          ...
          socialIcons.forEach((socialIcon: any) => {
            tl.fromTo(
              socialIcon,
              0.4,
              { y: "20", opacity: 0 },
      ...
      <div className={styles.parallaxContainer} ref={parallaxContainerRef}>
        ...
        <div className={styles.heroSection} ref={heroRef} id="home">
          ...
          <div className={styles.mainSection__container}>
            ...
            >
              <h2 className={styles.mainSection__title} id="hero-title">
                Jishnu Pavithran
              </h2>
                ...
                <div className={styles.aboutSectionContentLeft}>
                  <div className={styles.aboutHero} id="aboutpara">
                    <div className={styles.aboutHeroContent}>
                      <h3 className={styles.aboutHeroTitle}>
                      ...
                      <div className={styles.aboutHeroMeta}>
                        <div className={styles.aboutHeroMetaItem}>
                          <span className={styles.aboutHeroMetaValue}>
                            <span className={styles.aboutHeroMetaBadge}>5+ Years</span> Building Scalable Web Apps
                          </span>
                        </div>
                    ...
                    <div className={styles.aboutMissionContent}>
                      <div className={styles.aboutMissionText}>
                        <div className={styles.aboutMissionHeader}>
                          ...
                          <h2 className={styles.aboutMissionCompany}>
                            THOUGHTSPOT{" "}
                            <span className={styles.aboutMissionIndicator}></span>
                          </h2>
                        </div>
                      ...
                      <div className={styles.aboutMissionVisual}>
                        ...
                        >
                          <rect x="10" y="10" width="180" height="140" rx="4" stroke="currentColor" strokeWidth="1.5" opacity="0.3" />
                          <rect x="10" y="10" width="180" height="20" rx="4" fill="currentColor" opacity="0.1" />
                          ...
                          <rect x="20" y="40" width="75" height="50" rx="3" stroke="currentColor" strokeWidth="1" opacity="0.3" />
                          <polyline points="25,75 35,65 45,70 55,55 65,60 75,50 85,55" stroke="#9da284" strokeWidth="2" fill="none" className={styles.chartLine} />
                          <rect x="105" y="40" width="75" height="50" rx="3" stroke="currentColor" strokeWidth="1" opacity="0.3" />
                          <rect x="115" y="70" width="8" height="15" fill="currentColor" opacity="0.4" className={styles.chartBar} />
                          <rect x="128" y="65" width="8" height="20" fill="currentColor" opacity="0.5" className={styles.chartBar} />
                          <rect x="141" y="60" width="8" height="25" fill="#9da284" opacity="0.8" className={styles.chartBar} />
                          <rect x="154" y="68" width="8" height="17" fill="currentColor" opacity="0.4" className={styles.chartBar} />
                          <rect x="167" y="72" width="8" height="13" fill="currentColor" opacity="0.3" className={styles.chartBar} />
                          <rect x="20" y="100" width="75" height="40" rx="3" stroke="currentColor" strokeWidth="1" opacity="0.3" />
                          <circle cx="57" cy="120" r="15" stroke="currentColor" strokeWidth="8" strokeDasharray="30 65" opacity="0.3" fill="none" transform="rotate(-90 57 120)" />
                          <circle cx="57" cy="120" r="15" stroke="#9da284" strokeWidth="8" strokeDasharray="35 60" opacity="0.7" fill="none" transform="rotate(20 57 120)" className={styles.chartArc} />
                          <rect x="105" y="100" width="75" height="40" rx="3" stroke="currentColor" strokeWidth="1" opacity="0.3" />
                          <line x1="110" y1="108" x2="175" y2="108" stroke="currentColor" strokeWidth="1" opacity="0.2" />
                          <line x1="110" y1="115" x2="175" y2="115" stroke="currentColor" strokeWidth="0.5" opacity="0.15" />
                          <line x1="110" y1="122" x2="175" y2="122" stroke="currentColor" strokeWidth="0.5" opacity="0.15" />
                          <line x1="110" y1="129" x2="175" y2="129" stroke="currentColor" strokeWidth="0.5" opacity="0.15" />
                          <line x1="110" y1="136" x2="175" y2="136" stroke="currentColor" strokeWidth="0.5" opacity="0.15" />
                          <polyline points="142,104 145,106 148,103 151,105 154,102 157,104" stroke="#9da284" strokeWidth="1.5" fill="none" opacity="0.6" className={styles.sparkline} />
                        </svg>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.aboutDescription} id="aboutpara">
                    <p>
                      ...
                      React, and Vue. Bridging the gap between design and
                      technology.
                    </p>
                  </div>
                </div>
